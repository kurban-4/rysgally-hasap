...
<div class="desktop-app-layout">
    ...
    <main class="app-main">
        <header class="main-header d-print-none">
            ...
            <div>
                <h4 class="fw-bold mb-0" style="color: #107A84;">{{__("app.report_title")}}</h4>
            ...
            <div class="report-container">
                ...
                <div class="panel-card">
                    <div class="table-header">
                        <h6 class="fw-bold mb-0">{{__("app.report_sold_medicines")}}</h6>
                    </div>
                    ...
                    <table class="table table-sm report-table m-0 d-none d-sm-table">
                        ...
                        <tbody>
                            @foreach($report['medicines'] as $medicineId => $items)
                            <tr>
                                <td class="ps-4 py-3 fw-bold">{{ $items->first()->medicine->name ?? 'Товар удален' }}</td>
                    ...
                    <div class="d-sm-none report-items-mobile">
                        ...
                        <div class="report-item-row">
                            <div class="fw-bold">{{ $items->first()->medicine->name ?? 'Товар удален' }}</div>
