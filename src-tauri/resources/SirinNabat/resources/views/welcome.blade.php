                ...
                <div class="nav-grid animate-grid">
                    ...
                    <a href="{{ route('sales.index') }}" class="nav-card primary-card">
                        <div class="card-content">
                            ...
                            <div class="text-wrapper">
                                ...
                                <p>Кассовый терминал (POS), сканирование штрих-кодов и чеки</p>
                            </div>
                        </div>
                    ...
                    <a href="{{ route('sales.customers.index') }}" class="nav-card">
                        <div class="card-content">
                            ...
                            <div class="text-wrapper">
                                ...
                                <p>Просмотр завершенных транзакций и печать чеков</p>
                            </div>
                        </div>
                        <div class="card-arrow"><i class="bi bi-arrow-right"></i></div>
                    </a>
                    ...
                    <a href="{{ route('storage.index') }}" class="nav-card">
                        <div class="card-content">
                            ...
                            <div class="text-wrapper">
                                <h3>Розничный склад</h3>
                                <p>Управление остатками, ценами и сроками годности</p>
                            </div>
                        </div>
                        <div class="card-arrow"><i class="bi bi-arrow-right"></i></div>
                    </a>
                    ...
                    <a href="{{ route('wholesale.index') }}" class="nav-card">
                        <div class="card-content">
                            ...
                            <div class="text-wrapper">
                                ...
                                <p>Оформление крупных партий и работа с контрагентами</p>
                            </div>
                        </div>
                        <div class="card-arrow"><i class="bi bi-arrow-right"></i></div>
                    </a>
                    ...
                    <a href="{{ route('wholesale_storage.index') }}" class="nav-card">
                        <div class="card-content">
                            ...
                            <div class="text-wrapper">
                                <h3>Оптовый склад</h3>
                                <p>Приемка и хранение оптовых партий медикаментов</p>
                            </div>
                        </div>
                        <div class="card-arrow"><i class="bi bi-arrow-right"></i></div>
                    </a>
                    ...
                    <a href="{{ route('employees.index') }}" class="nav-card">
                        <div class="card-content">
                            ...
                            <div class="text-wrapper">
                                <h3>Сотрудники</h3>
                                <p>Управление персоналом, доступы и смены</p>
                            </div>
                        </div>
                        <div class="card-arrow"><i class="bi bi-arrow-right"></i></div>
                    </a>
...
body { margin: 0; padding: 0; font-family: 'Inter', sans-serif; background: var(--bg-light); }
...
.welcome-scroll::-webkit-scrollbar-thumb { background: #cbd5e0; border-radius: 10px; }
...
.brand-logo-mini {
    ...
    font-size: 1.5rem;
    box-shadow: 0 8px 18px rgba(16,122,132,0.22);
    flex-shrink: 0;
}
...
.primary-card {
    ...
    border: none;
    box-shadow: 0 8px 24px rgba(16,122,132,0.25);
}
.primary-card::before { background: rgba(255,255,255,0.3) !important; }
.primary-card:hover { box-shadow: 0 18px 40px rgba(16,122,132,0.35); color: white !important; }
...
.icon-teal    { background: rgba(16,122,132,0.1);  color: var(--primary); }
...
.icon-gray    { background: #f8fafc; color: #64748b; border: 1px solid var(--border); }
...
.nav-card:not(.primary-card):hover .text-wrapper h3 { color: var(--primary); }
...
.nav-card:not(.primary-card):hover .card-arrow {
    background: var(--primary);
    border-color: var(--primary);
    color: white;
    transform: translateX(4px);
    box-shadow: 0 4px 12px rgba(16,122,132,0.25);
}
