    ...
    <form action="{{ route('wholesale.update', $invoice->id) }}" method="POST" id="edit-invoice-form">
        ...
        <div class="glass-card">
            <div class="card-header-sirin">
                <div>
                    <h2 class="mb-0 fw-bold">Edit Wholesale Invoice</h2>
                    <span class="opacity-75">Ref: #{{ $invoice->invoice_no }}</span>
                </div>
                <div class="text-end">
                    <p class="mb-0 small">Date Issued</p>
            ...
            <div class="p-4 p-md-5">
                <div class="sirin-input-group">
                    <label class="form-label fw-bold small text-muted text-uppercase">Client / Organization Name</label>
                    <div class="input-group">
                        ...
                        <input type="text" name="customer_name" class="form-control border-0 bg-white p-3"
                            value="{{ $invoice->customer_name }}" style="border-radius: 0 8px 8px 0;">
                    </div>
                </div>

                <h5 class="mb-4 fw-bold"><i class="bi bi-box-seam me-2"></i>Product List</h5>
                ...
                <div class="row mt-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="total-badge">
                            <span class="text-muted text-uppercase small fw-bold">Grand Total Amount</span>
                ...
                <div class="text-end mt-4">
                    <button type="submit" class="btn-update">
                        <i class="bi bi-check2-circle me-2"></i> Confirm & Save Changes
                    </button>
                </div>
            </div>
        </div>
